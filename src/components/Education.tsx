  ...
  return (
    <section id="education">
      <div className="container">
        ...
        <ul>
          <li>
            Психолог-консультант в сфере сексуальных отношений, профессиональная
            переподготовка (1194 ак.ч.), <br />
            Психодемия –{" "}
            <strong>
          ...
          <li>
            Современные взгляды на вопросы гендерной и сексуальной вариативности
            (8 ак.ч.), Психодемия
          </li>
          <li>
        ...
        <cite>
          *Это работа с более опытным профессионалом или встречи с коллегами, на
          которых происходит обмен опытом и оказывается помощь при возникновении
          затруднений
        </cite>
      </div>
    </section>
